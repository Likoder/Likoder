...
* Пользователь хочет просмотреть команды разных офисов, чтобы 
...
* Пользователь хочет видеть дни рождения в формате списка, чтобы просматривать ближайшие события не открывая календарь;
