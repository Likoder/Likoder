...
Функциональность: при нажатии открывается панель с фильтрами для сортировки списка сотрудников (по отделу, должности и т.д.).
...
#### FE
##### Задача:
На сайте для сотрудников необходимо добавить вкладку "Дни рождения", где будет отображаться информация о днях рождения сотрудников и их детей в виде списка и календаря. В календаре
...
Функциональность: при нажатии открывается панель с фильтрами для сортировки дней рождений по конкретным месяцам.
...
Функциональность: при нажатии открывается панель с фильтрами (по причине отсутствия, сотруднику и т.д.).
...
Разместить справа тэг с причиной отсутствия, каждая причина соответсвует своему цвету. Черный текст по середине с периодом отсутсвия и под ним серым текстом количество дней.ц
